...
// Module: InformationTheory.NewTargets
// Imports: Init VerifiedAgora.tagger InformationTheory.Hamming
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_InformationTheory_NewTargets(uint8_t builtin, lean_object* w) {
lean_object * res;
