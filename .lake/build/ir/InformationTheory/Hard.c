...
// Module: InformationTheory.Hard
// Imports: Init VerifiedAgora.tagger Mathlib.Data.Nat.Prime.Basic
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_InformationTheory_Hard(uint8_t builtin, lean_object* w) {
lean_object * res;
