...
// Imports: Init Mathlib.Algebra.BigOperators.Field Mathlib.Analysis.SpecialFunctions.Exponential Mathlib.Combinatorics.Derangements.Finite Mathlib.Data.Nat.Cast.Field
#include <lean/lean.h>
...
lean_object* initialize_Mathlib_Combinatorics_Derangements_Finite(uint8_t builtin, lean_object*);
lean_object* initialize_Mathlib_Data_Nat_Cast_Field(uint8_t builtin, lean_object*);
static bool _G_initialized = false;
LEAN_EXPORT lean_object* initialize_Mathlib_Combinatorics_Derangements_Exponential(uint8_t builtin, lean_object* w) {
lean_object * res;
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_Mathlib_Combinatorics_Derangements_Finite(builtin, lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
