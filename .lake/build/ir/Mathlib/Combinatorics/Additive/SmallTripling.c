...
// Module: Mathlib.Combinatorics.Additive.SmallTripling
// Imports: Init Mathlib.Combinatorics.Additive.PluenneckeRuzsa Mathlib.Data.Fin.VecNotation Mathlib.Data.Real.Basic Mathlib.Tactic.FinCases Mathlib.Tactic.Linarith Mathlib.Tactic.NormNum Mathlib.Tactic.Positivity.Finset Mathlib.Tactic.Ring
#include <lean/lean.h>
...
lean_object* initialize_Mathlib_Combinatorics_Additive_PluenneckeRuzsa(uint8_t builtin, lean_object*);
...
LEAN_EXPORT lean_object* initialize_Mathlib_Combinatorics_Additive_SmallTripling(uint8_t builtin, lean_object* w) {
lean_object * res;
...
lean_dec_ref(res);
res = initialize_Mathlib_Combinatorics_Additive_PluenneckeRuzsa(builtin, lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
