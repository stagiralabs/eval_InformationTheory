...
// Imports: Init Mathlib.Data.Fintype.Card Mathlib.Order.UpperLower.Basic
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Combinatorics_SetFamily_Intersecting(uint8_t builtin, lean_object* w) {
lean_object * res;
