...
// Imports: Init Mathlib.Combinatorics.SimpleGraph.Path Mathlib.Data.ENat.Lattice
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Combinatorics_SimpleGraph_Metric(uint8_t builtin, lean_object* w) {
lean_object * res;
