...
// Imports: Init Mathlib.Combinatorics.SimpleGraph.Path Mathlib.Tactic.Linarith
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Combinatorics_SimpleGraph_Acyclic(uint8_t builtin, lean_object* w) {
lean_object * res;
