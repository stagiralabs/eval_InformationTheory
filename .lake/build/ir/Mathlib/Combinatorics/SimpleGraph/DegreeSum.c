...
// Imports: Init Mathlib.Algebra.BigOperators.Ring.Finset Mathlib.Combinatorics.SimpleGraph.Dart Mathlib.Combinatorics.SimpleGraph.Finite Mathlib.Data.ZMod.Basic
#include <lean/lean.h>
...
lean_object* initialize_Mathlib_Combinatorics_SimpleGraph_Dart(uint8_t builtin, lean_object*);
...
LEAN_EXPORT lean_object* initialize_Mathlib_Combinatorics_SimpleGraph_DegreeSum(uint8_t builtin, lean_object* w) {
lean_object * res;
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_Mathlib_Combinatorics_SimpleGraph_Dart(builtin, lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
