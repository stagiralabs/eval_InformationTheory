...
// Module: Mathlib.LinearAlgebra.FreeAlgebra
// Imports: Init Mathlib.Algebra.FreeAlgebra Mathlib.LinearAlgebra.Basis.Cardinality Mathlib.LinearAlgebra.Dimension.StrongRankCondition Mathlib.LinearAlgebra.Finsupp.VectorSpace Mathlib.LinearAlgebra.FreeModule.Basic Mathlib.LinearAlgebra.FreeModule.StrongRankCondition
#include <lean/lean.h>
...
lean_object* initialize_Mathlib_Algebra_FreeAlgebra(uint8_t builtin, lean_object*);
lean_object* initialize_Mathlib_LinearAlgebra_Basis_Cardinality(uint8_t builtin, lean_object*);
...
LEAN_EXPORT lean_object* initialize_Mathlib_LinearAlgebra_FreeAlgebra(uint8_t builtin, lean_object* w) {
lean_object * res;
...
lean_dec_ref(res);
res = initialize_Mathlib_Algebra_FreeAlgebra(builtin, lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_Mathlib_LinearAlgebra_Basis_Cardinality(builtin, lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
