...
// Imports: Init Mathlib.Algebra.Polynomial.Basic Mathlib.FieldTheory.IsAlgClosed.Basic
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_LinearAlgebra_Matrix_Charpoly_Eigs(uint8_t builtin, lean_object* w) {
lean_object * res;
