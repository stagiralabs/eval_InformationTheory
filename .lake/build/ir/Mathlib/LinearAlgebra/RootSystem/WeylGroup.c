...
// Imports: Init Mathlib.LinearAlgebra.RootSystem.Hom
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_LinearAlgebra_RootSystem_WeylGroup(uint8_t builtin, lean_object* w) {
lean_object * res;
