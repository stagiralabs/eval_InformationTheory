...
// Imports: Init Mathlib.Data.Finsupp.Encodable Mathlib.Data.Set.Countable Mathlib.LinearAlgebra.Finsupp.LinearCombination
#include <lean/lean.h>
...
lean_object* initialize_Mathlib_Data_Finsupp_Encodable(uint8_t builtin, lean_object*);
...
LEAN_EXPORT lean_object* initialize_Mathlib_LinearAlgebra_Countable(uint8_t builtin, lean_object* w) {
lean_object * res;
...
lean_dec_ref(res);
res = initialize_Mathlib_Data_Finsupp_Encodable(builtin, lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
