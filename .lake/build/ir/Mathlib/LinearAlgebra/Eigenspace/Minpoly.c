...
// Imports: Init Mathlib.LinearAlgebra.Eigenspace.Basic Mathlib.FieldTheory.Minpoly.Field
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_LinearAlgebra_Eigenspace_Minpoly(uint8_t builtin, lean_object* w) {
lean_object * res;
