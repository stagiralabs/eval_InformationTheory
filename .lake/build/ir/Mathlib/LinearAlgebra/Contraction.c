...
// Imports: Init Mathlib.LinearAlgebra.Dual Mathlib.LinearAlgebra.Matrix.ToLin
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_LinearAlgebra_Contraction(uint8_t builtin, lean_object* w) {
lean_object * res;
