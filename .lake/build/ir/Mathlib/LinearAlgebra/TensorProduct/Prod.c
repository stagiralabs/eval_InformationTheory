...
// Imports: Init Mathlib.LinearAlgebra.Prod Mathlib.LinearAlgebra.TensorProduct.Tower
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_LinearAlgebra_TensorProduct_Prod(uint8_t builtin, lean_object* w) {
lean_object * res;
