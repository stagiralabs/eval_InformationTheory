...
// Imports: Init Mathlib.LinearAlgebra.BilinearMap Mathlib.LinearAlgebra.Basis.Defs
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_LinearAlgebra_Basis_Bilinear(uint8_t builtin, lean_object* w) {
lean_object * res;
