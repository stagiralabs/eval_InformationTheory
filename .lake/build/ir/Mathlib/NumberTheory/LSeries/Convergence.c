...
// Imports: Init Mathlib.NumberTheory.LSeries.Basic Mathlib.Data.Real.EReal
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_NumberTheory_LSeries_Convergence(uint8_t builtin, lean_object* w) {
lean_object * res;
