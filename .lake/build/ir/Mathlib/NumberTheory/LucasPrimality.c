...
// Imports: Init Mathlib.Algebra.Field.ZMod Mathlib.RingTheory.IntegralDomain
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_NumberTheory_LucasPrimality(uint8_t builtin, lean_object* w) {
lean_object * res;
