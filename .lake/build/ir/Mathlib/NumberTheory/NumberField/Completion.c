...
// Module: Mathlib.NumberTheory.NumberField.Completion
// Imports: Init Mathlib.Algebra.Field.Subfield.Basic Mathlib.Analysis.Normed.Module.Completion Mathlib.Analysis.Normed.Ring.WithAbs Mathlib.NumberTheory.NumberField.Embeddings
#include <lean/lean.h>
...
lean_object* initialize_Mathlib_Analysis_Normed_Ring_WithAbs(uint8_t builtin, lean_object*);
lean_object* initialize_Mathlib_NumberTheory_NumberField_Embeddings(uint8_t builtin, lean_object*);
static bool _G_initialized = false;
LEAN_EXPORT lean_object* initialize_Mathlib_NumberTheory_NumberField_Completion(uint8_t builtin, lean_object* w) {
lean_object * res;
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_Mathlib_Analysis_Normed_Ring_WithAbs(builtin, lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
