...
// Module: Mathlib.NumberTheory.FLT.Polynomial
// Imports: Init Mathlib.Algebra.Polynomial.Expand Mathlib.Algebra.GroupWithZero.Defs Mathlib.NumberTheory.FLT.Basic Mathlib.NumberTheory.FLT.MasonStothers Mathlib.RingTheory.Polynomial.Content
#include <lean/lean.h>
...
lean_object* initialize_Mathlib_NumberTheory_FLT_MasonStothers(uint8_t builtin, lean_object*);
lean_object* initialize_Mathlib_RingTheory_Polynomial_Content(uint8_t builtin, lean_object*);
static bool _G_initialized = false;
LEAN_EXPORT lean_object* initialize_Mathlib_NumberTheory_FLT_Polynomial(uint8_t builtin, lean_object* w) {
lean_object * res;
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_Mathlib_NumberTheory_FLT_MasonStothers(builtin, lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
