...
// Module: Mathlib.NumberTheory.Transcendental.Lindemann.Init.AnalyticalPart
// Imports: Init Mathlib.Algebra.Polynomial.SumIteratedDerivative Mathlib.Analysis.Calculus.Deriv.Polynomial Mathlib.Analysis.SpecialFunctions.ExpDeriv Mathlib.MeasureTheory.Integral.FundThmCalculus Mathlib.RingTheory.Int.Basic Mathlib.Topology.Algebra.Polynomial
#include <lean/lean.h>
...
lean_object* initialize_Mathlib_Algebra_Polynomial_SumIteratedDerivative(uint8_t builtin, lean_object*);
...
LEAN_EXPORT lean_object* initialize_Mathlib_NumberTheory_Transcendental_Lindemann_Init_AnalyticalPart(uint8_t builtin, lean_object* w) {
lean_object * res;
...
lean_dec_ref(res);
res = initialize_Mathlib_Algebra_Polynomial_SumIteratedDerivative(builtin, lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
