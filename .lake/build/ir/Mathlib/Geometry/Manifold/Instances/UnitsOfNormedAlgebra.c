...
// Imports: Init Mathlib.Geometry.Manifold.Algebra.LieGroup
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Geometry_Manifold_Instances_UnitsOfNormedAlgebra(uint8_t builtin, lean_object* w) {
lean_object * res;
