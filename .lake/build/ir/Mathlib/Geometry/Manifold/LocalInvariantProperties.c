...
// Imports: Init Mathlib.Geometry.Manifold.ChartedSpace
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Geometry_Manifold_LocalInvariantProperties(uint8_t builtin, lean_object* w) {
lean_object * res;
