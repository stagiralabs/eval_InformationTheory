...
// Imports: Init Mathlib.Algebra.Polynomial.Degree.Support
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_RingTheory_Polynomial_Opposites(uint8_t builtin, lean_object* w) {
lean_object * res;
