...
// Module: Mathlib.RingTheory.Polynomial.Hermite.Gaussian
// Imports: Init Mathlib.RingTheory.Polynomial.Hermite.Basic Mathlib.Analysis.Calculus.Deriv.Add Mathlib.Analysis.Calculus.Deriv.Polynomial Mathlib.Analysis.SpecialFunctions.Exp Mathlib.Analysis.SpecialFunctions.ExpDeriv
#include <lean/lean.h>
...
lean_object* initialize_Mathlib_RingTheory_Polynomial_Hermite_Basic(uint8_t builtin, lean_object*);
...
LEAN_EXPORT lean_object* initialize_Mathlib_RingTheory_Polynomial_Hermite_Gaussian(uint8_t builtin, lean_object* w) {
lean_object * res;
...
lean_dec_ref(res);
res = initialize_Mathlib_RingTheory_Polynomial_Hermite_Basic(builtin, lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
