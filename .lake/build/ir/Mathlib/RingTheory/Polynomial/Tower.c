...
// Imports: Init Mathlib.Algebra.Algebra.Tower Mathlib.Algebra.Polynomial.AlgebraMap
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_RingTheory_Polynomial_Tower(uint8_t builtin, lean_object* w) {
lean_object * res;
