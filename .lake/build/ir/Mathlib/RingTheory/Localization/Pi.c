...
// Module: Mathlib.RingTheory.Localization.Pi
// Imports: Init Mathlib.Algebra.Algebra.Pi Mathlib.Algebra.BigOperators.Pi Mathlib.Algebra.Divisibility.Prod Mathlib.Algebra.Group.Submonoid.BigOperators Mathlib.Algebra.Group.Subgroup.Basic Mathlib.RingTheory.Localization.Basic Mathlib.Algebra.Group.Pi.Units
#include <lean/lean.h>
...
lean_object* initialize_Mathlib_Algebra_Divisibility_Prod(uint8_t builtin, lean_object*);
...
lean_object* initialize_Mathlib_Algebra_Group_Pi_Units(uint8_t builtin, lean_object*);
static bool _G_initialized = false;
LEAN_EXPORT lean_object* initialize_Mathlib_RingTheory_Localization_Pi(uint8_t builtin, lean_object* w) {
lean_object * res;
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_Mathlib_Algebra_Divisibility_Prod(builtin, lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_Mathlib_Algebra_Group_Pi_Units(builtin, lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
