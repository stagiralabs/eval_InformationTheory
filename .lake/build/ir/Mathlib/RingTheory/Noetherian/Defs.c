...
// Imports: Init Mathlib.Order.Filter.AtTopBot.Basic Mathlib.RingTheory.Finiteness.Basic
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_RingTheory_Noetherian_Defs(uint8_t builtin, lean_object* w) {
lean_object * res;
