...
// Imports: Init Mathlib.RingTheory.Finiteness.Defs Mathlib.RingTheory.Nilpotent.Defs
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_RingTheory_Finiteness_Nilpotent(uint8_t builtin, lean_object* w) {
lean_object * res;
