...
// Imports: Init Mathlib.LinearAlgebra.Prod Mathlib.RingTheory.Finiteness.Defs
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_RingTheory_Finiteness_Prod(uint8_t builtin, lean_object* w) {
lean_object * res;
