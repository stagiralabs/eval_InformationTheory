...
// Imports: Init Mathlib.RingTheory.Finiteness.Finsupp Mathlib.RingTheory.Ideal.Maps
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_RingTheory_Finiteness_Ideal(uint8_t builtin, lean_object* w) {
lean_object * res;
