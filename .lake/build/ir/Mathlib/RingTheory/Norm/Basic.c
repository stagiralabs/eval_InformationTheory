...
// Module: Mathlib.RingTheory.Norm.Basic
// Imports: Init Mathlib.RingTheory.Norm.Defs Mathlib.FieldTheory.PrimitiveElement Mathlib.LinearAlgebra.Matrix.Charpoly.Minpoly Mathlib.LinearAlgebra.Matrix.ToLinearEquiv Mathlib.FieldTheory.IsAlgClosed.AlgebraicClosure Mathlib.FieldTheory.Galois.Basic
#include <lean/lean.h>
...
lean_object* initialize_Mathlib_RingTheory_Norm_Defs(uint8_t builtin, lean_object*);
...
LEAN_EXPORT lean_object* initialize_Mathlib_RingTheory_Norm_Basic(uint8_t builtin, lean_object* w) {
lean_object * res;
...
lean_dec_ref(res);
res = initialize_Mathlib_RingTheory_Norm_Defs(builtin, lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
