...
// Imports: Init Mathlib.Algebra.Algebra.Tower Mathlib.Algebra.MvPolynomial.Eval
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_RingTheory_MvPolynomial_Tower(uint8_t builtin, lean_object* w) {
lean_object * res;
