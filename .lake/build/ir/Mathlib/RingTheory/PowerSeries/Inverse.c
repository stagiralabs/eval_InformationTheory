...
// Module: Mathlib.RingTheory.PowerSeries.Inverse
// Imports: Init Mathlib.Algebra.Polynomial.FieldDivision Mathlib.RingTheory.DiscreteValuationRing.Basic Mathlib.RingTheory.MvPowerSeries.Inverse Mathlib.RingTheory.PowerSeries.Basic Mathlib.RingTheory.PowerSeries.Order Mathlib.RingTheory.LocalRing.ResidueField.Defs Mathlib.RingTheory.UniqueFactorizationDomain.Multiplicity Mathlib.Data.ENat.Lattice
#include <lean/lean.h>
...
lean_object* initialize_Mathlib_RingTheory_MvPowerSeries_Inverse(uint8_t builtin, lean_object*);
lean_object* initialize_Mathlib_RingTheory_PowerSeries_Basic(uint8_t builtin, lean_object*);
lean_object* initialize_Mathlib_RingTheory_PowerSeries_Order(uint8_t builtin, lean_object*);
...
LEAN_EXPORT lean_object* initialize_Mathlib_RingTheory_PowerSeries_Inverse(uint8_t builtin, lean_object* w) {
lean_object * res;
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_Mathlib_RingTheory_MvPowerSeries_Inverse(builtin, lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_Mathlib_RingTheory_PowerSeries_Basic(builtin, lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_Mathlib_RingTheory_PowerSeries_Order(builtin, lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
