...
// Imports: Init Mathlib.Algebra.Group.Units.Defs Mathlib.Algebra.Ring.Defs
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_RingTheory_LocalRing_Defs(uint8_t builtin, lean_object* w) {
lean_object * res;
