...
// Imports: Init Mathlib.RingTheory.Ideal.IsPrimary Mathlib.Order.Minimal
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_RingTheory_Ideal_MinimalPrime_Basic(uint8_t builtin, lean_object* w) {
lean_object * res;
