...
// Module: Mathlib.RingTheory.Fintype
// Imports: Init Mathlib.Data.ZMod.Basic Mathlib.Tactic.NormNum
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_RingTheory_Fintype(uint8_t builtin, lean_object* w) {
lean_object * res;
