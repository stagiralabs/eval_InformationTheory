...
// Imports: Init Mathlib.Data.Matrix.Basis Mathlib.RingTheory.TensorProduct.Basic
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_RingTheory_MatrixAlgebra(uint8_t builtin, lean_object* w) {
lean_object * res;
