...
// Imports: Init Mathlib.Algebra.Equiv.TransferInstance Mathlib.RingTheory.Finiteness.Cardinality
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_RingTheory_OrzechProperty(uint8_t builtin, lean_object* w) {
lean_object * res;
