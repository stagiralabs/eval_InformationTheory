...
// Imports: Init Mathlib.LinearAlgebra.FreeModule.PID Mathlib.LinearAlgebra.FreeModule.Finite.Basic Mathlib.LinearAlgebra.BilinearForm.DualLattice Mathlib.RingTheory.DedekindDomain.Basic Mathlib.RingTheory.Localization.Module Mathlib.RingTheory.Trace.Basic
#include <lean/lean.h>
...
lean_object* initialize_Mathlib_LinearAlgebra_BilinearForm_DualLattice(uint8_t builtin, lean_object*);
...
LEAN_EXPORT lean_object* initialize_Mathlib_RingTheory_DedekindDomain_IntegralClosure(uint8_t builtin, lean_object* w) {
lean_object * res;
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_Mathlib_LinearAlgebra_BilinearForm_DualLattice(builtin, lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
