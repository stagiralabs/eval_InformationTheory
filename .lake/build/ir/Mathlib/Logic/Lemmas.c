...
// Imports: Init Mathlib.Logic.Basic Mathlib.Tactic.Convert Mathlib.Tactic.SplitIfs Mathlib.Tactic.Tauto
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Logic_Lemmas(uint8_t builtin, lean_object* w) {
lean_object * res;
