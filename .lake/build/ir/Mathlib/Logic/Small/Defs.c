...
// Imports: Init Mathlib.Logic.Equiv.Defs Mathlib.Tactic.MkIffOfInductiveProp Mathlib.Tactic.PPWithUniv
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Logic_Small_Defs(uint8_t builtin, lean_object* w) {
lean_object * res;
