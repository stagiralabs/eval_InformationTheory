...
// Imports: Init Mathlib.Logic.Function.Basic Mathlib.Data.Set.Defs
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Logic_Pairwise(uint8_t builtin, lean_object* w) {
lean_object * res;
