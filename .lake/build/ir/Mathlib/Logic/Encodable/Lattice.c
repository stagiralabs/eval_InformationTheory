...
// Imports: Init Mathlib.Logic.Encodable.Basic Mathlib.Logic.Pairwise Mathlib.Data.Set.Subsingleton
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Logic_Encodable_Lattice(uint8_t builtin, lean_object* w) {
lean_object * res;
