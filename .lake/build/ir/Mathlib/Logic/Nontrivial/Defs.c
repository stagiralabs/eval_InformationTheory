...
// Imports: Init Mathlib.Logic.Function.Defs Mathlib.Tactic.TypeStar
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Logic_Nontrivial_Defs(uint8_t builtin, lean_object* w) {
lean_object * res;
