...
// Imports: Init Mathlib.GroupTheory.Coset.Basic Mathlib.SetTheory.Cardinal.Finite
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_GroupTheory_Coset_Card(uint8_t builtin, lean_object* w) {
lean_object * res;
