...
// Imports: Init Mathlib.Order.Atoms Mathlib.Algebra.Group.Subgroup.Basic
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_GroupTheory_Subgroup_Simple(uint8_t builtin, lean_object* w) {
lean_object * res;
