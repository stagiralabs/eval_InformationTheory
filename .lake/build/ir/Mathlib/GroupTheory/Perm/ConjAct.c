...
// Module: Mathlib.GroupTheory.Perm.ConjAct
// Imports: Init Mathlib.Algebra.Group.Pointwise.Finset.Basic Mathlib.GroupTheory.GroupAction.ConjAct Mathlib.GroupTheory.Perm.Cycle.Basic Mathlib.GroupTheory.Perm.Cycle.Factors Mathlib.GroupTheory.Perm.Support
#include <lean/lean.h>
...
lean_object* initialize_Mathlib_GroupTheory_Perm_Cycle_Factors(uint8_t builtin, lean_object*);
lean_object* initialize_Mathlib_GroupTheory_Perm_Support(uint8_t builtin, lean_object*);
static bool _G_initialized = false;
LEAN_EXPORT lean_object* initialize_Mathlib_GroupTheory_Perm_ConjAct(uint8_t builtin, lean_object* w) {
lean_object * res;
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_Mathlib_GroupTheory_Perm_Cycle_Factors(builtin, lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
