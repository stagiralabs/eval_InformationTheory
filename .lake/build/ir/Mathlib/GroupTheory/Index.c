...
// Imports: Init Mathlib.Algebra.BigOperators.GroupWithZero.Finset Mathlib.Data.Finite.Card Mathlib.Data.Finite.Prod Mathlib.Data.Set.Card Mathlib.GroupTheory.Coset.Card Mathlib.GroupTheory.GroupAction.Quotient Mathlib.GroupTheory.QuotientGroup.Basic
#include <lean/lean.h>
...
lean_object* initialize_Mathlib_GroupTheory_Coset_Card(uint8_t builtin, lean_object*);
...
LEAN_EXPORT lean_object* initialize_Mathlib_GroupTheory_Index(uint8_t builtin, lean_object* w) {
lean_object * res;
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_Mathlib_GroupTheory_Coset_Card(builtin, lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
