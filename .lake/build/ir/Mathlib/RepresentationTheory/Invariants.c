...
// Imports: Init Mathlib.RepresentationTheory.Basic Mathlib.RepresentationTheory.FDRep
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_RepresentationTheory_Invariants(uint8_t builtin, lean_object* w) {
lean_object * res;
