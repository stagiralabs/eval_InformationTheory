...
// Imports: Init Mathlib.Data.Fintype.EquivFin Mathlib.Data.Fintype.Sigma
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Data_Finite_Sigma(uint8_t builtin, lean_object* w) {
lean_object * res;
