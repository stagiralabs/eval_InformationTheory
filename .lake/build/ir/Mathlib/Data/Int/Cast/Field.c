...
// Imports: Init Mathlib.Algebra.Field.Defs Mathlib.Algebra.Ring.Int.Defs
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Data_Int_Cast_Field(uint8_t builtin, lean_object* w) {
lean_object * res;
