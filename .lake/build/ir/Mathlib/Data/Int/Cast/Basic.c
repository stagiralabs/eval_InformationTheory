...
// Imports: Init Mathlib.Data.Int.Cast.Defs Mathlib.Algebra.Group.Basic Mathlib.Data.Nat.Basic
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Data_Int_Cast_Basic(uint8_t builtin, lean_object* w) {
lean_object * res;
