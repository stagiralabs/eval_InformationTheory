...
// Imports: Init Mathlib.Algebra.GroupWithZero.Associated Mathlib.Algebra.Ring.Int.Units
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Data_Int_Associated(uint8_t builtin, lean_object* w) {
lean_object * res;
