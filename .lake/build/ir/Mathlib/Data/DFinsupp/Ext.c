...
// Imports: Init Mathlib.Algebra.Group.Submonoid.Basic Mathlib.Data.DFinsupp.Defs
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Data_DFinsupp_Ext(uint8_t builtin, lean_object* w) {
lean_object * res;
