...
// Imports: Init Mathlib.Data.Finsupp.Single Mathlib.Data.Fintype.BigOperators
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Data_Finsupp_Fintype(uint8_t builtin, lean_object* w) {
lean_object * res;
