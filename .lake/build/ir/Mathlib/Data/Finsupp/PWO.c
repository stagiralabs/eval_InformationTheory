...
// Imports: Init Mathlib.Data.Finsupp.Order Mathlib.Order.WellFoundedSet
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Data_Finsupp_PWO(uint8_t builtin, lean_object* w) {
lean_object * res;
