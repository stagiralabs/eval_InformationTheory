...
// Imports: Init Mathlib.Data.Finset.Max Mathlib.Data.Finsupp.Defs
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Data_Finsupp_Single(uint8_t builtin, lean_object* w) {
lean_object * res;
