...
// Imports: Init Mathlib.Data.Finset.Union Mathlib.Data.Fintype.EquivFin
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Data_Fintype_Pigeonhole(uint8_t builtin, lean_object* w) {
lean_object * res;
