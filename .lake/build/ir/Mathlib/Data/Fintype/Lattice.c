...
// Imports: Init Mathlib.Data.Finset.Max Mathlib.Data.Fintype.Basic
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Data_Fintype_Lattice(uint8_t builtin, lean_object* w) {
lean_object * res;
