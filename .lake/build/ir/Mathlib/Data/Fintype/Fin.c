...
// Imports: Init Mathlib.Order.Interval.Finset.Fin Mathlib.Data.Vector.Basic
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Data_Fintype_Fin(uint8_t builtin, lean_object* w) {
lean_object * res;
