...
// Imports: Init Mathlib.Data.Finset.Lattice.Fold Mathlib.Data.Finset.Prod
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Data_Finset_Lattice_Prod(uint8_t builtin, lean_object* w) {
lean_object * res;
