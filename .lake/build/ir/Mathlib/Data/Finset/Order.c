...
// Imports: Init Mathlib.Data.Finset.Defs Mathlib.Data.Multiset.ZeroCons Mathlib.Order.Directed
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Data_Finset_Order(uint8_t builtin, lean_object* w) {
lean_object * res;
