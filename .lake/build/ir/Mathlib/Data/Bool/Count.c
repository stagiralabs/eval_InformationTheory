...
// Imports: Init Mathlib.Algebra.Order.Ring.Nat Mathlib.Data.List.Chain
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Data_Bool_Count(uint8_t builtin, lean_object* w) {
lean_object * res;
