...
// Module: Mathlib.Data.Bool.AllAny
// Imports: Init Batteries.Tactic.Alias Mathlib.Tactic.TypeStar
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Data_Bool_AllAny(uint8_t builtin, lean_object* w) {
lean_object * res;
