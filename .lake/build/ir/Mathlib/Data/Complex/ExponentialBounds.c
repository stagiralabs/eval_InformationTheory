...
// Imports: Init Mathlib.Data.Complex.Exponential Mathlib.Analysis.SpecialFunctions.Log.Deriv
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Data_Complex_ExponentialBounds(uint8_t builtin, lean_object* w) {
lean_object * res;
