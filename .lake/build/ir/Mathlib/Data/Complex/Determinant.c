...
// Imports: Init Mathlib.Data.Complex.Module Mathlib.LinearAlgebra.Determinant
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Data_Complex_Determinant(uint8_t builtin, lean_object* w) {
lean_object * res;
