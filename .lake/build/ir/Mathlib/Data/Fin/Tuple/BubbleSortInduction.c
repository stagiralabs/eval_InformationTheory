...
// Imports: Init Mathlib.Data.Fin.Tuple.Sort Mathlib.Order.WellFounded Mathlib.Order.PiLex Mathlib.Data.Finite.Prod
#include <lean/lean.h>
...
lean_object* initialize_Mathlib_Data_Fin_Tuple_Sort(uint8_t builtin, lean_object*);
...
LEAN_EXPORT lean_object* initialize_Mathlib_Data_Fin_Tuple_BubbleSortInduction(uint8_t builtin, lean_object* w) {
lean_object * res;
...
lean_dec_ref(res);
res = initialize_Mathlib_Data_Fin_Tuple_Sort(builtin, lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
