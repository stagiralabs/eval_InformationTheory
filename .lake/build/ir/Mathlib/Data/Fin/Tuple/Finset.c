...
// Imports: Init Mathlib.Data.Finset.Prod Mathlib.Data.Fintype.Pi
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Data_Fin_Tuple_Finset(uint8_t builtin, lean_object* w) {
lean_object * res;
