...
// Imports: Init Mathlib.Data.Nat.Factorial.Basic Mathlib.Data.Nat.Prime.Basic
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Data_Nat_Prime_Factorial(uint8_t builtin, lean_object* w) {
lean_object * res;
