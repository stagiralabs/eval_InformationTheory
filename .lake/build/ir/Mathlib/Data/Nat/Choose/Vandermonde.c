...
// Imports: Init Mathlib.Algebra.Polynomial.Coeff Mathlib.Data.Nat.Choose.Basic
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Data_Nat_Choose_Vandermonde(uint8_t builtin, lean_object* w) {
lean_object * res;
