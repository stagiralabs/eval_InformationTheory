...
// Imports: Init Mathlib.Algebra.Group.Nat.Defs Mathlib.Algebra.Group.Basic Mathlib.Data.Nat.Bits
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Data_Nat_Size(uint8_t builtin, lean_object* w) {
lean_object * res;
