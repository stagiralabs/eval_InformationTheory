...
// Imports: Init Batteries.Data.Nat.Gcd Mathlib.Algebra.BigOperators.Group.Finset.Defs
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Data_Nat_GCD_BigOperators(uint8_t builtin, lean_object* w) {
lean_object * res;
