...
// Imports: Init Mathlib.Algebra.Ring.Periodic Mathlib.Data.Nat.Count
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Data_Nat_Periodic(uint8_t builtin, lean_object* w) {
lean_object * res;
