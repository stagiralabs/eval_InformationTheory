...
// Imports: Init Mathlib.Data.Countable.Defs Mathlib.Data.Fin.Tuple.Basic Mathlib.Data.ENat.Defs Mathlib.Logic.Equiv.Nat
#include <lean/lean.h>
...
lean_object* initialize_Mathlib_Data_ENat_Defs(uint8_t builtin, lean_object*);
lean_object* initialize_Mathlib_Logic_Equiv_Nat(uint8_t builtin, lean_object*);
static bool _G_initialized = false;
LEAN_EXPORT lean_object* initialize_Mathlib_Data_Countable_Basic(uint8_t builtin, lean_object* w) {
lean_object * res;
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_Mathlib_Data_ENat_Defs(builtin, lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
