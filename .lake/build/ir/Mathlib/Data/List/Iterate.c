...
// Imports: Init Mathlib.Algebra.Order.Ring.Nat Mathlib.Data.List.Defs Mathlib.Data.Set.Function
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Data_List_Iterate(uint8_t builtin, lean_object* w) {
lean_object * res;
