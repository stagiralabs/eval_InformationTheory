...
// Imports: Init Mathlib.Data.List.Basic Mathlib.Data.Prod.Basic
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Data_List_ProdSigma(uint8_t builtin, lean_object* w) {
lean_object * res;
