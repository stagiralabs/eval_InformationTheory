...
// Imports: Init Mathlib.Algebra.BigOperators.Group.List.Lemmas Mathlib.Algebra.GroupWithZero.Associated
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Data_List_Prime(uint8_t builtin, lean_object* w) {
lean_object * res;
