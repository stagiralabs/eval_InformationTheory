...
// Imports: Init Mathlib.Data.Rat.Cast.CharZero Mathlib.Algebra.BigOperators.Group.Finset.Defs
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Data_Rat_BigOperators(uint8_t builtin, lean_object* w) {
lean_object * res;
