...
// Imports: Init Mathlib.Data.Set.Lattice Mathlib.Order.Directed
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Data_Set_UnionLift(uint8_t builtin, lean_object* w) {
lean_object * res;
