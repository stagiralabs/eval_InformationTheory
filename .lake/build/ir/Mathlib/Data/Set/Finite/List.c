...
// Module: Mathlib.Data.Set.Finite.List
// Imports: Init Mathlib.Data.Set.Finite.Basic Mathlib.Data.Set.Finite.Lattice Mathlib.Data.Set.Finite.Range Mathlib.Data.Set.Lattice Mathlib.Data.Finite.Sigma Mathlib.Data.Finite.Vector
#include <lean/lean.h>
...
lean_object* initialize_Mathlib_Data_Finite_Vector(uint8_t builtin, lean_object*);
static bool _G_initialized = false;
LEAN_EXPORT lean_object* initialize_Mathlib_Data_Set_Finite_List(uint8_t builtin, lean_object* w) {
lean_object * res;
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_Mathlib_Data_Finite_Vector(builtin, lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
