...
// Imports: Init Mathlib.Algebra.Order.BigOperators.Group.Finset Mathlib.Algebra.Order.Ring.Defs
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Data_Set_Equitable(uint8_t builtin, lean_object* w) {
lean_object * res;
