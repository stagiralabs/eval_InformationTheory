...
// Imports: Init Mathlib.Data.Set.Function Mathlib.Data.Set.Functor
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Data_Set_Subset(uint8_t builtin, lean_object* w) {
lean_object * res;
