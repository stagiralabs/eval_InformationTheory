...
// Imports: Init Mathlib.Analysis.Asymptotics.AsymptoticEquivalent Mathlib.Analysis.SpecialFunctions.Pow.Real Mathlib.Algebra.Order.ToIntervalMod Mathlib.Analysis.SpecialFunctions.Log.Base
#include <lean/lean.h>
