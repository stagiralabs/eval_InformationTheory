...
// Imports: Init Mathlib.Computability.PartrecCode Mathlib.Data.Set.Subsingleton
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Computability_Halting(uint8_t builtin, lean_object* w) {
lean_object * res;
