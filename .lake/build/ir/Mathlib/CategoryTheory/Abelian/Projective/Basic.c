...
// Module: Mathlib.CategoryTheory.Abelian.Projective.Basic
// Imports: Init Mathlib.CategoryTheory.Abelian.Exact Mathlib.CategoryTheory.Preadditive.Yoneda.Projective Mathlib.CategoryTheory.Preadditive.Yoneda.Limits Mathlib.Algebra.Category.ModuleCat.EpiMono Mathlib.Algebra.Homology.ShortComplex.ExactFunctor
#include <lean/lean.h>
...
lean_object* initialize_Mathlib_CategoryTheory_Preadditive_Yoneda_Projective(uint8_t builtin, lean_object*);
...
LEAN_EXPORT lean_object* initialize_Mathlib_CategoryTheory_Abelian_Projective_Basic(uint8_t builtin, lean_object* w) {
lean_object * res;
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_Mathlib_CategoryTheory_Preadditive_Yoneda_Projective(builtin, lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
