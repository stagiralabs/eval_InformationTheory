...
// Imports: Init Mathlib.CategoryTheory.Adjunction.Basic Mathlib.CategoryTheory.HomCongr
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_CategoryTheory_Adjunction_Restrict(uint8_t builtin, lean_object* w) {
lean_object * res;
