...
// Imports: Init Mathlib.CategoryTheory.FinCategory.Basic Mathlib.Data.Fintype.EquivFin
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_CategoryTheory_FinCategory_AsType(uint8_t builtin, lean_object* w) {
lean_object * res;
