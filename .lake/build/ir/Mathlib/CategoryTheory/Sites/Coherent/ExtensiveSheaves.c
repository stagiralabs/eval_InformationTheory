...
// Imports: Init Mathlib.CategoryTheory.Limits.Preserves.Finite Mathlib.CategoryTheory.Sites.Canonical Mathlib.CategoryTheory.Sites.Coherent.Basic Mathlib.CategoryTheory.Sites.Preserves
#include <lean/lean.h>
...
lean_object* initialize_Mathlib_CategoryTheory_Sites_Preserves(uint8_t builtin, lean_object*);
static bool _G_initialized = false;
LEAN_EXPORT lean_object* initialize_Mathlib_CategoryTheory_Sites_Coherent_ExtensiveSheaves(uint8_t builtin, lean_object* w) {
lean_object * res;
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_Mathlib_CategoryTheory_Sites_Preserves(builtin, lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
