...
// Imports: Init Mathlib.CategoryTheory.Limits.Preserves.Basic
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_CategoryTheory_Limits_Preserves_Limits(uint8_t builtin, lean_object* w) {
lean_object * res;
