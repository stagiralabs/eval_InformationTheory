...
// Imports: Init Mathlib.CategoryTheory.Limits.Final Mathlib.CategoryTheory.Limits.Shapes.FiniteProducts Mathlib.CategoryTheory.Countable Mathlib.Data.Countable.Defs
#include <lean/lean.h>
...
lean_object* initialize_Mathlib_CategoryTheory_Countable(uint8_t builtin, lean_object*);
lean_object* initialize_Mathlib_Data_Countable_Defs(uint8_t builtin, lean_object*);
static bool _G_initialized = false;
LEAN_EXPORT lean_object* initialize_Mathlib_CategoryTheory_Limits_Shapes_Countable(uint8_t builtin, lean_object* w) {
lean_object * res;
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_Mathlib_CategoryTheory_Countable(builtin, lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
