...
// Imports: Init Mathlib.CategoryTheory.Filtered.Basic Mathlib.CategoryTheory.IsConnected
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_CategoryTheory_Filtered_Connected(uint8_t builtin, lean_object* w) {
lean_object * res;
