...
// Imports: Init Mathlib.CategoryTheory.Limits.Shapes.FiniteLimits
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_CategoryTheory_Filtered_Basic(uint8_t builtin, lean_object* w) {
lean_object * res;
