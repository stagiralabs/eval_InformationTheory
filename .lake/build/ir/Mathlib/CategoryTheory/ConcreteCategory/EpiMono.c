...
// Imports: Init Mathlib.CategoryTheory.Limits.Shapes.Images Mathlib.CategoryTheory.MorphismProperty.Concrete Mathlib.CategoryTheory.Types Mathlib.CategoryTheory.Limits.Preserves.Basic Mathlib.CategoryTheory.Limits.Constructions.EpiMono
#include <lean/lean.h>
...
lean_object* initialize_Mathlib_CategoryTheory_MorphismProperty_Concrete(uint8_t builtin, lean_object*);
...
LEAN_EXPORT lean_object* initialize_Mathlib_CategoryTheory_ConcreteCategory_EpiMono(uint8_t builtin, lean_object* w) {
lean_object * res;
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_Mathlib_CategoryTheory_MorphismProperty_Concrete(builtin, lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
