...
// Module: Mathlib.CategoryTheory.EffectiveEpi.Comp
...
LEAN_EXPORT lean_object* initialize_Mathlib_CategoryTheory_EffectiveEpi_Comp(uint8_t builtin, lean_object* w) {
lean_object * res;
