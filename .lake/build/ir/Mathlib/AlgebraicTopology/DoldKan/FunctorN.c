...
// Module: Mathlib.AlgebraicTopology.DoldKan.FunctorN
...
LEAN_EXPORT lean_object* initialize_Mathlib_AlgebraicTopology_DoldKan_FunctorN(uint8_t builtin, lean_object* w) {
lean_object * res;
