...
// Imports: Init Mathlib.Tactic.Linarith.Frontend Mathlib.Tactic.NormNum Mathlib.Tactic.Hint
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Tactic_Linarith(uint8_t builtin, lean_object* w) {
lean_object * res;
