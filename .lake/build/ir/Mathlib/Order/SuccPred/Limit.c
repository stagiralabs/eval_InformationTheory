...
// Imports: Init Mathlib.Order.SuccPred.Archimedean Mathlib.Order.BoundedOrder.Lattice
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Order_SuccPred_Limit(uint8_t builtin, lean_object* w) {
lean_object * res;
