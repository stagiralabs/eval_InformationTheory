...
// Imports: Init Mathlib.Order.BoundedOrder.Basic Mathlib.Order.Monotone.Basic
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Order_BoundedOrder_Monotone(uint8_t builtin, lean_object* w) {
lean_object * res;
