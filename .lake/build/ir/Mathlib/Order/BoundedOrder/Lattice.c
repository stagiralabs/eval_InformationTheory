...
// Imports: Init Mathlib.Order.BoundedOrder.Basic Mathlib.Order.Lattice
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Order_BoundedOrder_Lattice(uint8_t builtin, lean_object* w) {
lean_object * res;
