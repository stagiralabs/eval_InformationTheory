...
// Imports: Init Mathlib.Order.RelClasses Mathlib.Order.Interval.Set.Basic
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Order_Bounded(uint8_t builtin, lean_object* w) {
lean_object * res;
