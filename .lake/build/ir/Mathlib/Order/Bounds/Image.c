...
// Imports: Init Mathlib.Data.Set.NAry Mathlib.Order.Bounds.Defs
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Order_Bounds_Image(uint8_t builtin, lean_object* w) {
lean_object * res;
