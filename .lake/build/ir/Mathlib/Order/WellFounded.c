...
// Imports: Init Mathlib.Data.Set.Function Mathlib.Order.Bounds.Defs
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Order_WellFounded(uint8_t builtin, lean_object* w) {
lean_object * res;
