...
// Imports: Init Mathlib.Data.ENat.Lattice Mathlib.Order.OrderIsoNat Mathlib.Tactic.TFAE
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Order_Height(uint8_t builtin, lean_object* w) {
lean_object * res;
