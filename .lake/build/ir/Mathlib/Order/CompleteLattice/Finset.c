...
// Imports: Init Mathlib.Data.Finset.Option Mathlib.Data.Set.Lattice
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Order_CompleteLattice_Finset(uint8_t builtin, lean_object* w) {
lean_object * res;
