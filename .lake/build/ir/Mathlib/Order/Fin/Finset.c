...
// Imports: Init Mathlib.Order.Fin.Tuple Mathlib.Order.Hom.Set Mathlib.Data.Finset.Insert
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Order_Fin_Finset(uint8_t builtin, lean_object* w) {
lean_object * res;
