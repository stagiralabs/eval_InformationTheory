...
// Imports: Init Mathlib.Order.Fin.Basic Mathlib.Data.Fintype.Basic Mathlib.Tactic.FinCases
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Order_Fin_SuccAboveOrderIso(uint8_t builtin, lean_object* w) {
lean_object * res;
