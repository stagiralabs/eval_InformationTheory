...
// Imports: Init Mathlib.Logic.Function.Iterate Mathlib.Order.Monotone.Basic
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Order_Iterate(uint8_t builtin, lean_object* w) {
lean_object * res;
