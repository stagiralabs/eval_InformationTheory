...
// Imports: Init Mathlib.Data.Set.Operations Mathlib.Order.Lattice
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Order_Monotone_Monovary(uint8_t builtin, lean_object* w) {
lean_object * res;
