...
// Imports: Init Mathlib.Order.Filter.AtTopBot.Defs Mathlib.Order.Filter.Map Mathlib.Order.Filter.Tendsto Mathlib.Order.Interval.Set.OrderIso
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Order_Filter_AtTopBot_Map(uint8_t builtin, lean_object* w) {
lean_object * res;
