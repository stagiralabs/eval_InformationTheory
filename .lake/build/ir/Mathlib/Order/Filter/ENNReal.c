...
// Imports: Init Mathlib.Topology.Instances.ENNReal.Defs Mathlib.Topology.Algebra.Order.LiminfLimsup
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Order_Filter_ENNReal(uint8_t builtin, lean_object* w) {
lean_object * res;
