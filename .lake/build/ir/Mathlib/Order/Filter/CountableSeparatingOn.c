...
// Imports: Init Mathlib.Order.Filter.CountableInter
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Order_Filter_CountableSeparatingOn(uint8_t builtin, lean_object* w) {
lean_object * res;
