...
// Imports: Init Mathlib.Order.Filter.Basic Mathlib.Order.Filter.Map
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Order_Filter_Tendsto(uint8_t builtin, lean_object* w) {
lean_object * res;
