...
// Imports: Init Mathlib.Order.Interval.Set.OrdConnected Mathlib.Order.Filter.SmallSets Mathlib.Order.Filter.AtTopBot.Basic
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Order_Filter_Interval(uint8_t builtin, lean_object* w) {
lean_object * res;
