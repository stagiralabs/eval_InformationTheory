...
// Imports: Init Mathlib.Data.Set.Image Mathlib.Order.Interval.Set.Basic Mathlib.Order.WithBot
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Order_Interval_Set_WithBotTop(uint8_t builtin, lean_object* w) {
lean_object * res;
