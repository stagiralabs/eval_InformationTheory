...
// Imports: Init Mathlib.Order.Interval.Set.OrdConnected Mathlib.Data.Set.Lattice
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Order_Interval_Set_OrdConnectedComponent(uint8_t builtin, lean_object* w) {
lean_object * res;
