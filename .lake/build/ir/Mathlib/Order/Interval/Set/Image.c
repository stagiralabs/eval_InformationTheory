...
// Imports: Init Mathlib.Order.Interval.Set.Basic Mathlib.Data.Set.Function Mathlib.Order.Directed
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Order_Interval_Set_Image(uint8_t builtin, lean_object* w) {
lean_object * res;
