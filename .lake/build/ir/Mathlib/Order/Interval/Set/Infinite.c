...
// Imports: Init Mathlib.Data.Set.Finite.Basic Mathlib.Order.Interval.Set.Basic
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Order_Interval_Set_Infinite(uint8_t builtin, lean_object* w) {
lean_object * res;
