...
// Imports: Init Mathlib.Order.Interval.Set.UnorderedInterval Mathlib.Order.Hom.Basic
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Order_Interval_Set_OrderEmbedding(uint8_t builtin, lean_object* w) {
lean_object * res;
