...
// Imports: Init Mathlib.Algebra.Star.Basic Mathlib.Algebra.BigOperators.Group.Finset.Defs
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Algebra_Star_BigOperators(uint8_t builtin, lean_object* w) {
lean_object * res;
