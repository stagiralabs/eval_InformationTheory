...
// Imports: Init Mathlib.Algebra.DirectSum.Module Mathlib.Data.Finsupp.ToDFinsupp
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Algebra_DirectSum_Finsupp(uint8_t builtin, lean_object* w) {
lean_object * res;
