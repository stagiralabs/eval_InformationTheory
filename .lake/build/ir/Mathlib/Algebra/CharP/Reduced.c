...
// Imports: Init Mathlib.Algebra.CharP.Lemmas Mathlib.RingTheory.Nilpotent.Defs
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Algebra_CharP_Reduced(uint8_t builtin, lean_object* w) {
lean_object * res;
