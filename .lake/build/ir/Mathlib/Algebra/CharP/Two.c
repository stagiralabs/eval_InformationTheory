...
// Imports: Init Mathlib.Algebra.CharP.Lemmas Mathlib.GroupTheory.OrderOfElement
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Algebra_CharP_Two(uint8_t builtin, lean_object* w) {
lean_object * res;
