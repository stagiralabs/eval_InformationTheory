...
// Imports: Init Mathlib.Algebra.CharP.Defs Mathlib.Algebra.Ring.Pi
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Algebra_CharP_Pi(uint8_t builtin, lean_object* w) {
lean_object * res;
