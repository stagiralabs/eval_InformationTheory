...
// Imports: Init Mathlib.Algebra.Field.Defs Mathlib.Tactic.Common
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Algebra_Field_IsField(uint8_t builtin, lean_object* w) {
lean_object * res;
