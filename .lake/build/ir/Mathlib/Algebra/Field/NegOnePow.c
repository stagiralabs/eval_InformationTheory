...
// Imports: Init Mathlib.Algebra.Field.Defs Mathlib.Algebra.Ring.NegOnePow Mathlib.Tactic.NormNum
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Algebra_Field_NegOnePow(uint8_t builtin, lean_object* w) {
lean_object * res;
