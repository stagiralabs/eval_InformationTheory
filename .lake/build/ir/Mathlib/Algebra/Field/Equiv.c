...
// Imports: Init Mathlib.Algebra.Field.IsField Mathlib.Algebra.GroupWithZero.Hom
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Algebra_Field_Equiv(uint8_t builtin, lean_object* w) {
lean_object * res;
