...
// Imports: Init Mathlib.Algebra.Group.Defs Mathlib.Order.Defs.Unbundled
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Algebra_Group_Semiconj_Defs(uint8_t builtin, lean_object* w) {
lean_object * res;
