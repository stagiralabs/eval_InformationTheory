...
// Imports: Init Mathlib.Algebra.Group.Action.Prod Mathlib.Data.PNat.Basic
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Algebra_Group_PNatPowAssoc(uint8_t builtin, lean_object* w) {
lean_object * res;
