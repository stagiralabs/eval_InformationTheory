...
// Imports: Init Mathlib.Algebra.BigOperators.Finsupp Mathlib.Algebra.Group.Subgroup.Lattice
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Algebra_Group_Subgroup_Finsupp(uint8_t builtin, lean_object* w) {
lean_object * res;
