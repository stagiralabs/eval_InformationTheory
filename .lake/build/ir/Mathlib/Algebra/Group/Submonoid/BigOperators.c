...
// Imports: Init Mathlib.Algebra.Group.Submonoid.Defs Mathlib.Data.Finset.NoncommProd
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Algebra_Group_Submonoid_BigOperators(uint8_t builtin, lean_object* w) {
lean_object * res;
