...
// Imports: Init Mathlib.Algebra.Group.Nat.Defs Mathlib.Algebra.Group.TypeTags.Basic
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Algebra_Group_Nat_TypeTags(uint8_t builtin, lean_object* w) {
lean_object * res;
