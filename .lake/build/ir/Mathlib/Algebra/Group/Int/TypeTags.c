...
// Imports: Init Mathlib.Algebra.Group.Int.Defs Mathlib.Algebra.Group.TypeTags.Basic
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Algebra_Group_Int_TypeTags(uint8_t builtin, lean_object* w) {
lean_object * res;
