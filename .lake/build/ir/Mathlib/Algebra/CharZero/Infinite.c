...
// Imports: Init Mathlib.Algebra.CharZero.Defs Mathlib.Data.Fintype.EquivFin
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Algebra_CharZero_Infinite(uint8_t builtin, lean_object* w) {
lean_object * res;
