...
// Imports: Init Mathlib.Data.Int.Cast.Defs Mathlib.Logic.Basic
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Algebra_CharZero_Defs(uint8_t builtin, lean_object* w) {
lean_object * res;
