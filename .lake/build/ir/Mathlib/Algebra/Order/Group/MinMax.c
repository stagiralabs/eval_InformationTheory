...
// Imports: Init Mathlib.Algebra.Order.Group.Abs Mathlib.Algebra.Order.Monoid.Unbundled.MinMax
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Algebra_Order_Group_MinMax(uint8_t builtin, lean_object* w) {
lean_object * res;
