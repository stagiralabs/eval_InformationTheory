...
// Imports: Init Mathlib.Order.Bounds.Basic Mathlib.Algebra.Order.Group.Defs
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Algebra_Order_Group_Bounds(uint8_t builtin, lean_object* w) {
lean_object * res;
