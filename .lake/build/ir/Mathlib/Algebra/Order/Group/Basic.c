...
// Imports: Init Mathlib.Algebra.Order.Group.Defs Mathlib.Algebra.Order.Monoid.Unbundled.Pow
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Algebra_Order_Group_Basic(uint8_t builtin, lean_object* w) {
lean_object * res;
