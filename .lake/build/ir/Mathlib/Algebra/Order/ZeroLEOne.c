...
// Imports: Init Mathlib.Order.Basic Mathlib.Data.One.Defs
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Algebra_Order_ZeroLEOne(uint8_t builtin, lean_object* w) {
lean_object * res;
