...
// Imports: Init Mathlib.Algebra.Order.SuccPred Mathlib.Order.PartialSups
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Algebra_Order_PartialSups(uint8_t builtin, lean_object* w) {
lean_object * res;
