...
// Imports: Init Mathlib.Algebra.Group.Action.Defs Mathlib.Algebra.Order.Monoid.Defs
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Algebra_Order_AddTorsor(uint8_t builtin, lean_object* w) {
lean_object * res;
