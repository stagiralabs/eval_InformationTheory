...
// Imports: Init Mathlib.Algebra.Order.Monoid.Canonical.Defs Mathlib.Algebra.Order.Monoid.Unbundled.OrderDual Mathlib.Algebra.BigOperators.Group.List.Basic
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Algebra_Order_BigOperators_Group_List(uint8_t builtin, lean_object* w) {
lean_object * res;
