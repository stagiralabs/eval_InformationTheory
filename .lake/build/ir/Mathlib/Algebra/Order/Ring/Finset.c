...
// Imports: Init Mathlib.Data.Finset.Lattice.Fold Mathlib.Data.Nat.Cast.Order.Ring
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Algebra_Order_Ring_Finset(uint8_t builtin, lean_object* w) {
lean_object * res;
