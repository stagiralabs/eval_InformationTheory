...
// Imports: Init Mathlib.Data.Nat.Cast.Commute Mathlib.Data.Nat.Cast.Order.Ring
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Algebra_Order_Ring_Pow(uint8_t builtin, lean_object* w) {
lean_object * res;
