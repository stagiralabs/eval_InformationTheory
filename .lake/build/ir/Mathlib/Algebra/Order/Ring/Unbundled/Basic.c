...
// Imports: Init Mathlib.Algebra.Group.Pi.Basic Mathlib.Algebra.Group.Units.Basic Mathlib.Algebra.GroupWithZero.NeZero Mathlib.Algebra.Order.Group.Unbundled.Basic Mathlib.Algebra.Order.GroupWithZero.Unbundled Mathlib.Algebra.Order.Monoid.Unbundled.ExistsOfLE Mathlib.Algebra.Order.Monoid.NatCast Mathlib.Algebra.Order.Monoid.Unbundled.MinMax Mathlib.Algebra.Ring.Defs Mathlib.Tactic.Tauto
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Algebra_Order_Ring_Unbundled_Basic(uint8_t builtin, lean_object* w) {
lean_object * res;
