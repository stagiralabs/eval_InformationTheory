...
// Imports: Init Mathlib.Algebra.Order.Monoid.Unbundled.Basic Mathlib.Order.MinMax
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Algebra_Order_Monoid_Unbundled_ExistsOfLE(uint8_t builtin, lean_object* w) {
lean_object * res;
