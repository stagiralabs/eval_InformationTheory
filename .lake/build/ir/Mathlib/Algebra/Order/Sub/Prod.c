...
// Imports: Init Mathlib.Algebra.Group.Prod Mathlib.Algebra.Order.Sub.Defs
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Algebra_Order_Sub_Prod(uint8_t builtin, lean_object* w) {
lean_object * res;
