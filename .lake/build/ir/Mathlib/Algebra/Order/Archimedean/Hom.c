...
// Imports: Init Mathlib.Algebra.Order.Archimedean.Basic Mathlib.Algebra.Order.Hom.Ring
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Algebra_Order_Archimedean_Hom(uint8_t builtin, lean_object* w) {
lean_object * res;
