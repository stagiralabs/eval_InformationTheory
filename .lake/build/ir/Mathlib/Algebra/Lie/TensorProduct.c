...
// Imports: Init Mathlib.Algebra.Lie.Abelian Mathlib.LinearAlgebra.TensorProduct.Tower
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Algebra_Lie_TensorProduct(uint8_t builtin, lean_object* w) {
lean_object * res;
