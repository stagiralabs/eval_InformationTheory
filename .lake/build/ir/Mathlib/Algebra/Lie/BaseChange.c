...
// Module: Mathlib.Algebra.Lie.BaseChange
// Imports: Init Mathlib.Algebra.Algebra.RestrictScalars Mathlib.Algebra.Lie.TensorProduct Mathlib.LinearAlgebra.TensorProduct.Tower Mathlib.RingTheory.TensorProduct.Basic
#include <lean/lean.h>
...
lean_object* initialize_Mathlib_Algebra_Lie_TensorProduct(uint8_t builtin, lean_object*);
...
LEAN_EXPORT lean_object* initialize_Mathlib_Algebra_Lie_BaseChange(uint8_t builtin, lean_object* w) {
lean_object * res;
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_Mathlib_Algebra_Lie_TensorProduct(builtin, lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
