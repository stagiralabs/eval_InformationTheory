...
// Imports: Init Mathlib.Algebra.Polynomial.Coeff Mathlib.Algebra.Polynomial.Eval.Defs
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Algebra_Polynomial_Eval_Coeff(uint8_t builtin, lean_object* w) {
lean_object * res;
