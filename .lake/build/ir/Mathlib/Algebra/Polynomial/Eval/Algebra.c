...
// Imports: Init Mathlib.Algebra.Algebra.Defs Mathlib.Algebra.Polynomial.Eval.Defs
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Algebra_Polynomial_Eval_Algebra(uint8_t builtin, lean_object* w) {
lean_object * res;
