...
// Imports: Init Mathlib.Algebra.GroupWithZero.NonZeroDivisors Mathlib.Algebra.Polynomial.Degree.Support Mathlib.Algebra.Polynomial.Degree.Units Mathlib.Algebra.Polynomial.Eval.Coeff
#include <lean/lean.h>
...
lean_object* initialize_Mathlib_Algebra_Polynomial_Degree_Units(uint8_t builtin, lean_object*);
lean_object* initialize_Mathlib_Algebra_Polynomial_Eval_Coeff(uint8_t builtin, lean_object*);
static bool _G_initialized = false;
LEAN_EXPORT lean_object* initialize_Mathlib_Algebra_Polynomial_Eval_Degree(uint8_t builtin, lean_object* w) {
lean_object * res;
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_Mathlib_Algebra_Polynomial_Degree_Units(builtin, lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
