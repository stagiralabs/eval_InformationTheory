...
// Imports: Init Mathlib.Algebra.Polynomial.Basic Mathlib.SetTheory.Cardinal.Finsupp
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Algebra_Polynomial_Cardinal(uint8_t builtin, lean_object* w) {
lean_object * res;
