...
// Imports: Init Mathlib.Algebra.Polynomial.Roots Mathlib.Tactic.IntervalCases
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Algebra_Polynomial_SpecificDegree(uint8_t builtin, lean_object* w) {
lean_object * res;
