...
// Imports: Init Mathlib.Algebra.Polynomial.Degree.Lemmas Mathlib.Tactic.ComputeDegree
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Algebra_Polynomial_CancelLeads(uint8_t builtin, lean_object* w) {
lean_object * res;
