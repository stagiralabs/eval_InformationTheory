...
// Imports: Init Mathlib.Algebra.Azumaya.Defs Mathlib.LinearAlgebra.Matrix.ToLin Mathlib.RingTheory.Finiteness.Basic Mathlib.GroupTheory.GroupAction.Hom
#include <lean/lean.h>
...
lean_object* initialize_Mathlib_Algebra_Azumaya_Defs(uint8_t builtin, lean_object*);
...
LEAN_EXPORT lean_object* initialize_Mathlib_Algebra_Azumaya_Basic(uint8_t builtin, lean_object* w) {
lean_object * res;
...
lean_dec_ref(res);
res = initialize_Mathlib_Algebra_Azumaya_Defs(builtin, lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
