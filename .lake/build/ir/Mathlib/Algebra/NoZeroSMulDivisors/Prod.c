...
// Imports: Init Mathlib.Algebra.NoZeroSMulDivisors.Defs Mathlib.Algebra.Group.Action.Prod
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Algebra_NoZeroSMulDivisors_Prod(uint8_t builtin, lean_object* w) {
lean_object * res;
