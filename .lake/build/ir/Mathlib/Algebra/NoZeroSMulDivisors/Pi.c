...
// Imports: Init Mathlib.Algebra.NoZeroSMulDivisors.Defs Mathlib.Algebra.Group.Action.Pi
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Algebra_NoZeroSMulDivisors_Pi(uint8_t builtin, lean_object* w) {
lean_object * res;
