...
// Imports: Init Mathlib.Algebra.Group.Indicator Mathlib.Algebra.GroupWithZero.Basic
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Algebra_GroupWithZero_Indicator(uint8_t builtin, lean_object* w) {
lean_object * res;
