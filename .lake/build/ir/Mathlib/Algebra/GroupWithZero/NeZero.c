...
// Imports: Init Mathlib.Algebra.GroupWithZero.Defs Mathlib.Algebra.NeZero
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Algebra_GroupWithZero_NeZero(uint8_t builtin, lean_object* w) {
lean_object * res;
