...
// Imports: Init Mathlib.Algebra.Group.Center Mathlib.Algebra.GroupWithZero.Units.Basic
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Algebra_GroupWithZero_Center(uint8_t builtin, lean_object* w) {
lean_object * res;
