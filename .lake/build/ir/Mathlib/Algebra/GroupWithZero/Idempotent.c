...
// Imports: Init Mathlib.Algebra.Group.Idempotent Mathlib.Algebra.GroupWithZero.Defs
#include <lean/lean.h>
...
lean_object* initialize_Mathlib_Algebra_Group_Idempotent(uint8_t builtin, lean_object*);
lean_object* initialize_Mathlib_Algebra_GroupWithZero_Defs(uint8_t builtin, lean_object*);
static bool _G_initialized = false;
LEAN_EXPORT lean_object* initialize_Mathlib_Algebra_GroupWithZero_Idempotent(uint8_t builtin, lean_object* w) {
lean_object * res;
...
lean_dec_ref(res);
res = initialize_Mathlib_Algebra_Group_Idempotent(builtin, lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
