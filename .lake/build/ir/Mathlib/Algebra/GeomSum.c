...
// Imports: Init Mathlib.Algebra.BigOperators.Intervals Mathlib.Algebra.BigOperators.Ring.Finset Mathlib.Algebra.Group.NatPowAssoc Mathlib.Algebra.Order.BigOperators.Ring.Finset Mathlib.Algebra.Ring.Opposite Mathlib.Tactic.Abel Mathlib.Algebra.Ring.Regular
#include <lean/lean.h>
...
lean_object* initialize_Mathlib_Algebra_Group_NatPowAssoc(uint8_t builtin, lean_object*);
...
LEAN_EXPORT lean_object* initialize_Mathlib_Algebra_GeomSum(uint8_t builtin, lean_object* w) {
lean_object * res;
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_Mathlib_Algebra_Group_NatPowAssoc(builtin, lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
