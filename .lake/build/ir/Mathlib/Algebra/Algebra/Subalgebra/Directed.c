...
// Imports: Init Mathlib.Algebra.Algebra.Subalgebra.Basic Mathlib.Data.Set.UnionLift
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Algebra_Algebra_Subalgebra_Directed(uint8_t builtin, lean_object* w) {
lean_object * res;
