...
// Imports: Init Mathlib.Algebra.Divisibility.Basic Mathlib.Algebra.Group.Units.Basic
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Algebra_Divisibility_Units(uint8_t builtin, lean_object* w) {
lean_object * res;
