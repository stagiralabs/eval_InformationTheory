...
// Imports: Init Mathlib.Data.Finset.Order Mathlib.RingTheory.FreeCommRing Mathlib.RingTheory.Ideal.Maps Mathlib.RingTheory.Ideal.Quotient.Defs Mathlib.Algebra.Colimit.DirectLimit Mathlib.Tactic.SuppressCompilation
#include <lean/lean.h>
...
lean_object* initialize_Mathlib_Algebra_Colimit_DirectLimit(uint8_t builtin, lean_object*);
lean_object* initialize_Mathlib_Tactic_SuppressCompilation(uint8_t builtin, lean_object*);
static bool _G_initialized = false;
LEAN_EXPORT lean_object* initialize_Mathlib_Algebra_Colimit_Ring(uint8_t builtin, lean_object* w) {
lean_object * res;
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_Mathlib_Algebra_Colimit_DirectLimit(builtin, lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
