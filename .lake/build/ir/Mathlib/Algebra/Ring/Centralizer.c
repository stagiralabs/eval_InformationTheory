...
// Imports: Init Mathlib.Algebra.Group.Center Mathlib.Algebra.Ring.Defs
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Algebra_Ring_Centralizer(uint8_t builtin, lean_object* w) {
lean_object * res;
