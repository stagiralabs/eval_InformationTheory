...
// Imports: Init Mathlib.Algebra.Group.Center Mathlib.Data.Int.Cast.Lemmas
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Algebra_Ring_Center(uint8_t builtin, lean_object* w) {
lean_object * res;
