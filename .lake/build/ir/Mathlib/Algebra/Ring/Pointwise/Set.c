...
// Imports: Init Mathlib.Algebra.Group.Pointwise.Set.Basic Mathlib.Algebra.Ring.Defs
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Algebra_Ring_Pointwise_Set(uint8_t builtin, lean_object* w) {
lean_object * res;
