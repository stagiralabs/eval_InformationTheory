...
// Imports: Init Mathlib.Algebra.GroupWithZero.NonZeroDivisors Mathlib.Algebra.Ring.Defs
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Algebra_Ring_NonZeroDivisors(uint8_t builtin, lean_object* w) {
lean_object * res;
