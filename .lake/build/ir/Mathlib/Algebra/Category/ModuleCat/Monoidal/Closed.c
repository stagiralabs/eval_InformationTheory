...
// Imports: Init Mathlib.CategoryTheory.Closed.Monoidal Mathlib.CategoryTheory.Linear.Yoneda Mathlib.Algebra.Category.ModuleCat.Monoidal.Symmetric
#include <lean/lean.h>
...
lean_object* initialize_Mathlib_CategoryTheory_Linear_Yoneda(uint8_t builtin, lean_object*);
lean_object* initialize_Mathlib_Algebra_Category_ModuleCat_Monoidal_Symmetric(uint8_t builtin, lean_object*);
static bool _G_initialized = false;
LEAN_EXPORT lean_object* initialize_Mathlib_Algebra_Category_ModuleCat_Monoidal_Closed(uint8_t builtin, lean_object* w) {
lean_object * res;
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_Mathlib_CategoryTheory_Linear_Yoneda(builtin, lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
