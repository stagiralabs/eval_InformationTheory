...
// Imports: Init Mathlib.Algebra.Small.Module Mathlib.LinearAlgebra.FreeModule.Finite.Basic Mathlib.LinearAlgebra.TensorProduct.RightExactness Mathlib.LinearAlgebra.Isomorphisms Mathlib.RingTheory.Finiteness.Projective Mathlib.RingTheory.Finiteness.TensorProduct Mathlib.RingTheory.Localization.BaseChange Mathlib.RingTheory.Noetherian.Basic
#include <lean/lean.h>
...
lean_object* initialize_Mathlib_Algebra_Small_Module(uint8_t builtin, lean_object*);
...
lean_object* initialize_Mathlib_RingTheory_Finiteness_Projective(uint8_t builtin, lean_object*);
...
LEAN_EXPORT lean_object* initialize_Mathlib_Algebra_Module_FinitePresentation(uint8_t builtin, lean_object* w) {
lean_object * res;
...
lean_dec_ref(res);
res = initialize_Mathlib_Algebra_Small_Module(builtin, lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_Mathlib_RingTheory_Finiteness_Projective(builtin, lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
