...
// Imports: Init Mathlib.Algebra.Exact Mathlib.Algebra.Module.LocalizedModule.Basic
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Algebra_Module_LocalizedModule_Exact(uint8_t builtin, lean_object* w) {
lean_object * res;
