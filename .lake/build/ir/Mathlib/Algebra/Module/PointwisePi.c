...
// Imports: Init Mathlib.Algebra.Group.Action.Pi Mathlib.Data.Set.Pointwise.SMul
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Algebra_Module_PointwisePi(uint8_t builtin, lean_object* w) {
lean_object * res;
