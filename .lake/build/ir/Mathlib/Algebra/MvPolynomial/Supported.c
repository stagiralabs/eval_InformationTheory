...
// Imports: Init Mathlib.Algebra.MvPolynomial.Variables
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Algebra_MvPolynomial_Supported(uint8_t builtin, lean_object* w) {
lean_object * res;
