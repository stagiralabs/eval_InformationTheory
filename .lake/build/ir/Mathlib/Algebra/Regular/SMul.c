...
// Imports: Init Mathlib.Algebra.Regular.Basic Mathlib.GroupTheory.GroupAction.Hom
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Algebra_Regular_SMul(uint8_t builtin, lean_object* w) {
lean_object * res;
