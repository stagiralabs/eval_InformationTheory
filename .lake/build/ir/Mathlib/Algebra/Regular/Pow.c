...
// Imports: Init Mathlib.Algebra.BigOperators.Group.Finset.Defs Mathlib.Algebra.Regular.Basic
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Algebra_Regular_Pow(uint8_t builtin, lean_object* w) {
lean_object * res;
