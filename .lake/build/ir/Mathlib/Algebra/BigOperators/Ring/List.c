...
// Imports: Init Mathlib.Algebra.GroupWithZero.Commute Mathlib.Algebra.GroupWithZero.Divisibility Mathlib.Algebra.Ring.Basic Mathlib.Algebra.Ring.Divisibility.Basic Mathlib.Algebra.Ring.Commute Mathlib.Algebra.BigOperators.Group.List.Basic
#include <lean/lean.h>
...
lean_object* initialize_Mathlib_Algebra_Ring_Commute(uint8_t builtin, lean_object*);
lean_object* initialize_Mathlib_Algebra_BigOperators_Group_List_Basic(uint8_t builtin, lean_object*);
static bool _G_initialized = false;
LEAN_EXPORT lean_object* initialize_Mathlib_Algebra_BigOperators_Ring_List(uint8_t builtin, lean_object* w) {
lean_object * res;
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_Mathlib_Algebra_Ring_Commute(builtin, lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
