...
// Imports: Init Mathlib.Algebra.Ring.Parity Mathlib.Algebra.BigOperators.Group.Finset.Basic
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Algebra_BigOperators_Ring_Nat(uint8_t builtin, lean_object* w) {
lean_object * res;
