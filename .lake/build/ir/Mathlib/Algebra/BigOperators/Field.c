...
// Imports: Init Mathlib.Algebra.BigOperators.Ring.Finset Mathlib.Algebra.Field.Defs
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Algebra_BigOperators_Field(uint8_t builtin, lean_object* w) {
lean_object * res;
