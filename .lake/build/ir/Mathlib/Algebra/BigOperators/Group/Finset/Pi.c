...
// Imports: Init Mathlib.Data.Fintype.Pi Mathlib.Algebra.BigOperators.Group.Finset.Defs
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Algebra_BigOperators_Group_Finset_Pi(uint8_t builtin, lean_object* w) {
lean_object * res;
