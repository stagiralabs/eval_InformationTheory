...
// Imports: Init Mathlib.Data.Finset.Option Mathlib.Algebra.BigOperators.Group.Finset.Basic
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Algebra_BigOperators_Option(uint8_t builtin, lean_object* w) {
lean_object * res;
