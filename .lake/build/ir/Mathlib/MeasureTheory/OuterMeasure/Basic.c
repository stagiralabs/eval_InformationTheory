...
// Imports: Init Mathlib.Data.Countable.Basic Mathlib.Data.Fin.VecNotation Mathlib.Order.Disjointed Mathlib.MeasureTheory.OuterMeasure.Defs Mathlib.Topology.Instances.ENNReal.Lemmas
#include <lean/lean.h>
...
lean_object* initialize_Mathlib_MeasureTheory_OuterMeasure_Defs(uint8_t builtin, lean_object*);
lean_object* initialize_Mathlib_Topology_Instances_ENNReal_Lemmas(uint8_t builtin, lean_object*);
static bool _G_initialized = false;
LEAN_EXPORT lean_object* initialize_Mathlib_MeasureTheory_OuterMeasure_Basic(uint8_t builtin, lean_object* w) {
lean_object * res;
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_Mathlib_MeasureTheory_OuterMeasure_Defs(builtin, lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
