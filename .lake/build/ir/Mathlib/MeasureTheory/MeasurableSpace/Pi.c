...
// Imports: Init Mathlib.MeasureTheory.MeasurableSpace.Basic Mathlib.MeasureTheory.PiSystem
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_MeasureTheory_MeasurableSpace_Pi(uint8_t builtin, lean_object* w) {
lean_object * res;
