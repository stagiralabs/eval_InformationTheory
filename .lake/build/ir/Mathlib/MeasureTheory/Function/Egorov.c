...
// Imports: Init Mathlib.MeasureTheory.Function.StronglyMeasurable.Basic
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_MeasureTheory_Function_Egorov(uint8_t builtin, lean_object* w) {
lean_object * res;
