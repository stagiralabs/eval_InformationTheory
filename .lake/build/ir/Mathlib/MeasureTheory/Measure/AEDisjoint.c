...
// Imports: Init Mathlib.MeasureTheory.Measure.MeasureSpaceDef
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_MeasureTheory_Measure_AEDisjoint(uint8_t builtin, lean_object* w) {
lean_object * res;
