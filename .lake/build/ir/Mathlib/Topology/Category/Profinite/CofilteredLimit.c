...
// Imports: Init Mathlib.Topology.Category.Profinite.Basic Mathlib.Topology.LocallyConstant.Basic Mathlib.Topology.DiscreteQuotient Mathlib.Topology.Category.TopCat.Limits.Cofiltered Mathlib.Topology.Category.TopCat.Limits.Konig
#include <lean/lean.h>
...
lean_object* initialize_Mathlib_Topology_Category_TopCat_Limits_Cofiltered(uint8_t builtin, lean_object*);
lean_object* initialize_Mathlib_Topology_Category_TopCat_Limits_Konig(uint8_t builtin, lean_object*);
static bool _G_initialized = false;
LEAN_EXPORT lean_object* initialize_Mathlib_Topology_Category_Profinite_CofilteredLimit(uint8_t builtin, lean_object* w) {
lean_object * res;
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_Mathlib_Topology_Category_TopCat_Limits_Cofiltered(builtin, lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
