...
// Imports: Init Mathlib.Topology.ContinuousOn Mathlib.Order.Filter.SmallSets
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Topology_LocallyFinite(uint8_t builtin, lean_object* w) {
lean_object * res;
