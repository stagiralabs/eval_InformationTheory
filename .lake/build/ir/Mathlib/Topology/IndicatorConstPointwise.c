...
// Imports: Init Mathlib.Algebra.Group.Indicator Mathlib.Topology.Separation.Basic
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Topology_IndicatorConstPointwise(uint8_t builtin, lean_object* w) {
lean_object * res;
