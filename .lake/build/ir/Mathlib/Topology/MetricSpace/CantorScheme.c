...
// Imports: Init Mathlib.Topology.MetricSpace.PiNat
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Topology_MetricSpace_CantorScheme(uint8_t builtin, lean_object* w) {
lean_object * res;
