...
// Imports: Init Mathlib.Analysis.SpecificLimits.Basic Mathlib.Data.Setoid.Basic Mathlib.Dynamics.FixedPoints.Topology Mathlib.Topology.MetricSpace.Lipschitz
#include <lean/lean.h>
...
lean_object* initialize_Mathlib_Dynamics_FixedPoints_Topology(uint8_t builtin, lean_object*);
lean_object* initialize_Mathlib_Topology_MetricSpace_Lipschitz(uint8_t builtin, lean_object*);
static bool _G_initialized = false;
LEAN_EXPORT lean_object* initialize_Mathlib_Topology_MetricSpace_Contracting(uint8_t builtin, lean_object* w) {
lean_object * res;
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_Mathlib_Dynamics_FixedPoints_Topology(builtin, lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
