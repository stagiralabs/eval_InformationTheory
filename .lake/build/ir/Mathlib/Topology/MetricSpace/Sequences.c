...
// Imports: Init Mathlib.Topology.Sequences Mathlib.Topology.MetricSpace.Bounded
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Topology_MetricSpace_Sequences(uint8_t builtin, lean_object* w) {
lean_object * res;
