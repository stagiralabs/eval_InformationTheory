...
// Imports: Init Mathlib.Topology.EMetricSpace.Defs
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Topology_MetricSpace_MetricSeparated(uint8_t builtin, lean_object* w) {
lean_object * res;
