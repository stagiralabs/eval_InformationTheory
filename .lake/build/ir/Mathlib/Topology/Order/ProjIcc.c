...
// Imports: Init Mathlib.Order.Interval.Set.ProjIcc Mathlib.Topology.Order.Basic
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Topology_Order_ProjIcc(uint8_t builtin, lean_object* w) {
lean_object * res;
