...
// Imports: Init Mathlib.Algebra.Ring.Pointwise.Set Mathlib.Order.Filter.AtTopBot.CompleteLattice Mathlib.Order.Filter.AtTopBot.Group Mathlib.Topology.Order.Basic
#include <lean/lean.h>
...
lean_object* initialize_Mathlib_Order_Filter_AtTopBot_Group(uint8_t builtin, lean_object*);
lean_object* initialize_Mathlib_Topology_Order_Basic(uint8_t builtin, lean_object*);
static bool _G_initialized = false;
LEAN_EXPORT lean_object* initialize_Mathlib_Topology_Order_LeftRightNhds(uint8_t builtin, lean_object* w) {
lean_object * res;
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_Mathlib_Order_Filter_AtTopBot_Group(builtin, lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
