...
// Imports: Init Mathlib.Topology.Constructions Mathlib.Topology.Order.OrderClosed
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Topology_Order_Lattice(uint8_t builtin, lean_object* w) {
lean_object * res;
