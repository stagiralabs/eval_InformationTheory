...
// Imports: Init Mathlib.Topology.Order.LeftRight Mathlib.Topology.Order.Monotone
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Topology_Order_LeftRightLim(uint8_t builtin, lean_object* w) {
lean_object * res;
