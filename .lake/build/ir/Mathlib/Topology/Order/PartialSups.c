...
// Imports: Init Mathlib.Topology.Order.Lattice Mathlib.Order.PartialSups
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Topology_Order_PartialSups(uint8_t builtin, lean_object* w) {
lean_object * res;
