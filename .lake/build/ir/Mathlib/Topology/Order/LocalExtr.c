...
// Imports: Init Mathlib.Algebra.Group.Defs Mathlib.Order.Filter.Extr Mathlib.Topology.ContinuousOn
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Topology_Order_LocalExtr(uint8_t builtin, lean_object* w) {
lean_object * res;
