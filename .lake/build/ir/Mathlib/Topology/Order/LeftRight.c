...
// Imports: Init Mathlib.Order.Antichain Mathlib.Topology.ContinuousOn
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Topology_Order_LeftRight(uint8_t builtin, lean_object* w) {
lean_object * res;
