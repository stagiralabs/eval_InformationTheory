...
// Imports: Init Mathlib.Topology.Algebra.Module.Equiv Mathlib.LinearAlgebra.Determinant
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Topology_Algebra_Module_Determinant(uint8_t builtin, lean_object* w) {
lean_object * res;
