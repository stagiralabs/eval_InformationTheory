...
// Imports: Init Mathlib.Algebra.Order.Archimedean.Basic Mathlib.Algebra.Order.BigOperators.Ring.Finset Mathlib.Topology.Algebra.InfiniteSum.NatInt Mathlib.Topology.Algebra.Order.Field Mathlib.Topology.Order.MonotoneConvergence
#include <lean/lean.h>
...
lean_object* initialize_Mathlib_Topology_Algebra_InfiniteSum_NatInt(uint8_t builtin, lean_object*);
...
LEAN_EXPORT lean_object* initialize_Mathlib_Topology_Algebra_InfiniteSum_Order(uint8_t builtin, lean_object* w) {
lean_object * res;
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_Mathlib_Topology_Algebra_InfiniteSum_NatInt(builtin, lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
