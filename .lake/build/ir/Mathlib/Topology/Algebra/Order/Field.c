...
// Imports: Init Mathlib.Algebra.Order.Group.Pointwise.Interval Mathlib.Order.Filter.AtTopBot.Field Mathlib.Topology.Algebra.Field Mathlib.Topology.Algebra.Order.Group
#include <lean/lean.h>
...
lean_object* initialize_Mathlib_Topology_Algebra_Order_Group(uint8_t builtin, lean_object*);
static bool _G_initialized = false;
LEAN_EXPORT lean_object* initialize_Mathlib_Topology_Algebra_Order_Field(uint8_t builtin, lean_object* w) {
lean_object * res;
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_Mathlib_Topology_Algebra_Order_Group(builtin, lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
