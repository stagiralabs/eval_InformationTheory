...
// Imports: Init Mathlib.GroupTheory.Archimedean Mathlib.Topology.Order.Basic
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Topology_Algebra_Order_Archimedean(uint8_t builtin, lean_object* w) {
lean_object * res;
