...
// Imports: Init Mathlib.Algebra.Group.Defs Mathlib.Topology.Separation.Regular
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Topology_Algebra_Semigroup(uint8_t builtin, lean_object* w) {
lean_object * res;
