...
// Imports: Init Mathlib.Topology.Algebra.Group.Basic Mathlib.Topology.Sets.Compacts
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Topology_Algebra_Group_Compact(uint8_t builtin, lean_object* w) {
lean_object * res;
