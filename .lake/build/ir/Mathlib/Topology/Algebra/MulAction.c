...
// Imports: Init Mathlib.Topology.Algebra.Constructions Mathlib.GroupTheory.GroupAction.SubMulAction Mathlib.Topology.Algebra.ConstMulAction Mathlib.Algebra.AddTorsor.Defs
#include <lean/lean.h>
...
lean_object* initialize_Mathlib_Topology_Algebra_ConstMulAction(uint8_t builtin, lean_object*);
lean_object* initialize_Mathlib_Algebra_AddTorsor_Defs(uint8_t builtin, lean_object*);
static bool _G_initialized = false;
LEAN_EXPORT lean_object* initialize_Mathlib_Topology_Algebra_MulAction(uint8_t builtin, lean_object* w) {
lean_object * res;
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_Mathlib_Topology_Algebra_ConstMulAction(builtin, lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
