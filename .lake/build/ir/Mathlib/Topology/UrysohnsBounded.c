...
// Imports: Init Mathlib.Topology.UrysohnsLemma Mathlib.Topology.ContinuousMap.Bounded.Basic
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Topology_UrysohnsBounded(uint8_t builtin, lean_object* w) {
lean_object * res;
