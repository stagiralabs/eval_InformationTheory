...
// Imports: Init Mathlib.Topology.Constructions Mathlib.Tactic.TFAE
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Topology_LocallyClosed(uint8_t builtin, lean_object* w) {
lean_object * res;
