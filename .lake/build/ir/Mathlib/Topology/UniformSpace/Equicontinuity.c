...
// Imports: Init Mathlib.Topology.UniformSpace.UniformConvergenceTopology
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Topology_UniformSpace_Equicontinuity(uint8_t builtin, lean_object* w) {
lean_object * res;
