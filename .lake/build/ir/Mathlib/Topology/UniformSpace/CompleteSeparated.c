...
// Imports: Init Mathlib.Topology.UniformSpace.UniformEmbedding
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Topology_UniformSpace_CompleteSeparated(uint8_t builtin, lean_object* w) {
lean_object * res;
