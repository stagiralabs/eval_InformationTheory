...
// Imports: Init Mathlib.Topology.UniformSpace.Cauchy
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Topology_UniformSpace_UniformConvergence(uint8_t builtin, lean_object* w) {
lean_object * res;
