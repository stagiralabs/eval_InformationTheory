...
// Imports: Init Mathlib.Topology.ContinuousOn Mathlib.Order.Minimal Mathlib.Order.Zorn
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Topology_Irreducible(uint8_t builtin, lean_object* w) {
lean_object * res;
