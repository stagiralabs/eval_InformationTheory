...
// Module: Mathlib.Topology.DerivedSet
// Imports: Init Mathlib.Topology.Perfect Mathlib.Tactic.Peel
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Topology_DerivedSet(uint8_t builtin, lean_object* w) {
lean_object * res;
