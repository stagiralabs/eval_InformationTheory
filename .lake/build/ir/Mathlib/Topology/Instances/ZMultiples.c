...
// Imports: Init Mathlib.Algebra.Algebra.Rat Mathlib.Algebra.Group.Subgroup.ZPowers.Lemmas Mathlib.Algebra.Module.Rat Mathlib.Algebra.Module.Submodule.Lattice Mathlib.Topology.Algebra.UniformGroup.Basic Mathlib.Topology.Instances.Real.Defs Mathlib.Topology.Metrizable.Basic
#include <lean/lean.h>
...
lean_object* initialize_Mathlib_Algebra_Group_Subgroup_ZPowers_Lemmas(uint8_t builtin, lean_object*);
...
LEAN_EXPORT lean_object* initialize_Mathlib_Topology_Instances_ZMultiples(uint8_t builtin, lean_object* w) {
lean_object * res;
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_Mathlib_Algebra_Group_Subgroup_ZPowers_Lemmas(builtin, lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
