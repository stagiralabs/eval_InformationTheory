...
// Module: Mathlib.Topology.Instances.Real.Defs
// Imports: Init Mathlib.Data.Real.Star Mathlib.Topology.Algebra.Order.Field Mathlib.Topology.Algebra.Star Mathlib.Topology.Algebra.UniformGroup.Defs Mathlib.Topology.Instances.Int Mathlib.Topology.Order.Bornology
#include <lean/lean.h>
...
lean_object* initialize_Mathlib_Topology_Order_Bornology(uint8_t builtin, lean_object*);
static bool _G_initialized = false;
LEAN_EXPORT lean_object* initialize_Mathlib_Topology_Instances_Real_Defs(uint8_t builtin, lean_object* w) {
lean_object * res;
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_Mathlib_Topology_Order_Bornology(builtin, lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
