...
// Module: Mathlib.Topology.ContinuousMap.Lattice
// Imports: Init Mathlib.Algebra.Algebra.Pi Mathlib.Algebra.Order.Group.Lattice Mathlib.Topology.ContinuousMap.Algebra Mathlib.Topology.ContinuousMap.Ordered
#include <lean/lean.h>
...
lean_object* initialize_Mathlib_Algebra_Order_Group_Lattice(uint8_t builtin, lean_object*);
...
LEAN_EXPORT lean_object* initialize_Mathlib_Topology_ContinuousMap_Lattice(uint8_t builtin, lean_object* w) {
lean_object * res;
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_Mathlib_Algebra_Order_Group_Lattice(builtin, lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
