...
// Module: Mathlib.Topology.ContinuousMap.StarOrdered
// Imports: Init Mathlib.Analysis.Complex.Basic Mathlib.Data.Real.StarOrdered Mathlib.Topology.ContinuousMap.Lattice Mathlib.Topology.ContinuousMap.ContinuousMapZero
#include <lean/lean.h>
...
lean_object* initialize_Mathlib_Data_Real_StarOrdered(uint8_t builtin, lean_object*);
...
LEAN_EXPORT lean_object* initialize_Mathlib_Topology_ContinuousMap_StarOrdered(uint8_t builtin, lean_object* w) {
lean_object * res;
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_Mathlib_Data_Real_StarOrdered(builtin, lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
