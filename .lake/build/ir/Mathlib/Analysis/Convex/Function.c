...
// Imports: Init Mathlib.Analysis.Convex.Basic Mathlib.Order.Filter.Extr Mathlib.Tactic.NormNum
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Analysis_Convex_Function(uint8_t builtin, lean_object* w) {
lean_object * res;
