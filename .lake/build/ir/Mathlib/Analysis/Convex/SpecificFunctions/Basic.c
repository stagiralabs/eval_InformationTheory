...
// Imports: Init Mathlib.Analysis.Convex.Slope Mathlib.Analysis.SpecialFunctions.Pow.Real Mathlib.Tactic.LinearCombination
#include <lean/lean.h>
...
lean_object* initialize_Mathlib_Analysis_Convex_Slope(uint8_t builtin, lean_object*);
...
LEAN_EXPORT lean_object* initialize_Mathlib_Analysis_Convex_SpecificFunctions_Basic(uint8_t builtin, lean_object* w) {
lean_object * res;
...
lean_dec_ref(res);
res = initialize_Mathlib_Analysis_Convex_Slope(builtin, lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
