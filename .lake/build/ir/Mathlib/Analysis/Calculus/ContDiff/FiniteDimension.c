...
// Module: Mathlib.Analysis.Calculus.ContDiff.FiniteDimension
...
LEAN_EXPORT lean_object* initialize_Mathlib_Analysis_Calculus_ContDiff_FiniteDimension(uint8_t builtin, lean_object* w) {
lean_object * res;
