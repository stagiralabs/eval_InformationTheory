...
// Imports: Init Mathlib.Analysis.Calculus.ContDiff.Operations Mathlib.Analysis.Calculus.UniformLimitsDeriv Mathlib.Topology.Algebra.InfiniteSum.Module Mathlib.Analysis.NormedSpace.FunctionSeries
#include <lean/lean.h>
...
lean_object* initialize_Mathlib_Analysis_Calculus_UniformLimitsDeriv(uint8_t builtin, lean_object*);
...
LEAN_EXPORT lean_object* initialize_Mathlib_Analysis_Calculus_SmoothSeries(uint8_t builtin, lean_object* w) {
lean_object * res;
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_Mathlib_Analysis_Calculus_UniformLimitsDeriv(builtin, lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
