...
// Imports: Init Mathlib.Analysis.Calculus.FDeriv.Prod
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Analysis_Calculus_FDeriv_Bilinear(uint8_t builtin, lean_object* w) {
lean_object * res;
