...
// Imports: Init Mathlib.Analysis.Analytic.IteratedFDeriv Mathlib.Analysis.Calculus.Deriv.Pow Mathlib.Analysis.Calculus.MeanValue Mathlib.Analysis.Calculus.ContDiff.Basic
#include <lean/lean.h>
...
lean_object* initialize_Mathlib_Analysis_Analytic_IteratedFDeriv(uint8_t builtin, lean_object*);
...
LEAN_EXPORT lean_object* initialize_Mathlib_Analysis_Calculus_FDeriv_Symmetric(uint8_t builtin, lean_object* w) {
lean_object * res;
...
lean_dec_ref(res);
res = initialize_Mathlib_Analysis_Analytic_IteratedFDeriv(builtin, lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
