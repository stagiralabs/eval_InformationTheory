...
// Imports: Init Mathlib.Analysis.Calculus.MeanValue Mathlib.Analysis.Calculus.Deriv.Inv
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Analysis_Calculus_LHopital(uint8_t builtin, lean_object* w) {
lean_object * res;
