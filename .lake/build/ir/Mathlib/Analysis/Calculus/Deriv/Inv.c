...
// Imports: Init Mathlib.Analysis.Calculus.Deriv.Mul Mathlib.Analysis.Calculus.Deriv.Comp
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Analysis_Calculus_Deriv_Inv(uint8_t builtin, lean_object* w) {
lean_object * res;
