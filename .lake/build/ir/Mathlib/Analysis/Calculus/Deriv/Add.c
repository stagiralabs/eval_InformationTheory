...
// Imports: Init Mathlib.Analysis.Calculus.Deriv.Basic Mathlib.Analysis.Calculus.FDeriv.Add
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Analysis_Calculus_Deriv_Add(uint8_t builtin, lean_object* w) {
lean_object * res;
