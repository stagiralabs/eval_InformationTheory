...
// Imports: Init Mathlib.Analysis.NormedSpace.OperatorNorm.NormedSpace
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Analysis_NormedSpace_OperatorNorm_Mul(uint8_t builtin, lean_object* w) {
lean_object * res;
