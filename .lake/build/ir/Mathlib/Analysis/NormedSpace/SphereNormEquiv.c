...
// Module: Mathlib.Analysis.NormedSpace.SphereNormEquiv
...
LEAN_EXPORT lean_object* initialize_Mathlib_Analysis_NormedSpace_SphereNormEquiv(uint8_t builtin, lean_object* w) {
lean_object * res;
