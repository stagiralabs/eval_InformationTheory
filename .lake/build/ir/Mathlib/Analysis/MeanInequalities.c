...
// Imports: Init Mathlib.Algebra.BigOperators.Expect Mathlib.Algebra.BigOperators.Field Mathlib.Analysis.Convex.Jensen Mathlib.Analysis.Convex.SpecificFunctions.Basic Mathlib.Analysis.SpecialFunctions.Pow.NNReal Mathlib.Data.Real.ConjExponents
#include <lean/lean.h>
...
lean_object* initialize_Mathlib_Data_Real_ConjExponents(uint8_t builtin, lean_object*);
static bool _G_initialized = false;
LEAN_EXPORT lean_object* initialize_Mathlib_Analysis_MeanInequalities(uint8_t builtin, lean_object* w) {
lean_object * res;
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_Mathlib_Data_Real_ConjExponents(builtin, lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
