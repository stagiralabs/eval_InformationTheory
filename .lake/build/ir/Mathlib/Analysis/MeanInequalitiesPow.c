...
// Imports: Init Mathlib.Analysis.Convex.Jensen Mathlib.Analysis.Convex.Mul Mathlib.Analysis.Convex.SpecificFunctions.Basic Mathlib.Analysis.SpecialFunctions.Pow.NNReal
#include <lean/lean.h>
...
lean_object* initialize_Mathlib_Analysis_Convex_Mul(uint8_t builtin, lean_object*);
...
LEAN_EXPORT lean_object* initialize_Mathlib_Analysis_MeanInequalitiesPow(uint8_t builtin, lean_object* w) {
lean_object * res;
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_Mathlib_Analysis_Convex_Mul(builtin, lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
