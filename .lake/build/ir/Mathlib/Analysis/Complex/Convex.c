...
// Imports: Init Mathlib.Analysis.Convex.Topology Mathlib.Analysis.Complex.ReImTopology
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Analysis_Complex_Convex(uint8_t builtin, lean_object* w) {
lean_object * res;
