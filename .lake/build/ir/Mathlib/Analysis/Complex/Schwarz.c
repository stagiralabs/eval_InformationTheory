...
// Imports: Init Mathlib.Analysis.Complex.AbsMax Mathlib.Analysis.Complex.RemovableSingularity
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Analysis_Complex_Schwarz(uint8_t builtin, lean_object* w) {
lean_object * res;
