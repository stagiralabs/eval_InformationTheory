...
// Imports: Init Mathlib.Analysis.Complex.CauchyIntegral
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Analysis_Complex_TaylorSeries(uint8_t builtin, lean_object* w) {
lean_object * res;
