...
// Imports: Init Mathlib.Analysis.Complex.Basic Mathlib.Analysis.NormedSpace.OperatorNorm.NormedSpace Mathlib.Data.Complex.Determinant
#include <lean/lean.h>
...
lean_object* initialize_Mathlib_Data_Complex_Determinant(uint8_t builtin, lean_object*);
static bool _G_initialized = false;
LEAN_EXPORT lean_object* initialize_Mathlib_Analysis_Complex_OperatorNorm(uint8_t builtin, lean_object* w) {
lean_object * res;
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_Mathlib_Data_Complex_Determinant(builtin, lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
