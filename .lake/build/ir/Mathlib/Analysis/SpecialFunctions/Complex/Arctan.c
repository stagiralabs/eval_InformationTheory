...
// Imports: Init Mathlib.Analysis.SpecialFunctions.Complex.LogBounds
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Analysis_SpecialFunctions_Complex_Arctan(uint8_t builtin, lean_object* w) {
lean_object * res;
