...
// Imports: Init Mathlib.Analysis.SpecialFunctions.Trigonometric.Complex
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Analysis_SpecialFunctions_Trigonometric_Arctan(uint8_t builtin, lean_object* w) {
lean_object * res;
