...
// Imports: Init Mathlib.Analysis.SpecialFunctions.Pow.NNReal
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Analysis_SpecialFunctions_Pow_Asymptotics(uint8_t builtin, lean_object* w) {
lean_object * res;
