...
// Imports: Init Mathlib.Analysis.SpecialFunctions.Complex.Log
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Analysis_SpecialFunctions_Pow_Complex(uint8_t builtin, lean_object* w) {
lean_object * res;
