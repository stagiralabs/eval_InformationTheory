...
// Imports: Init Mathlib.Analysis.Convex.Basic Mathlib.Analysis.Convex.Hull Mathlib.Analysis.Normed.Module.Basic Mathlib.Topology.Bornology.Absorbs
#include <lean/lean.h>
...
lean_object* initialize_Mathlib_Topology_Bornology_Absorbs(uint8_t builtin, lean_object*);
static bool _G_initialized = false;
LEAN_EXPORT lean_object* initialize_Mathlib_Analysis_LocallyConvex_Basic(uint8_t builtin, lean_object* w) {
lean_object * res;
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_Mathlib_Topology_Bornology_Absorbs(builtin, lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
