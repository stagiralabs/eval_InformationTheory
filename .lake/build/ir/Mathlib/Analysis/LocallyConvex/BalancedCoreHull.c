...
// Imports: Init Mathlib.Analysis.LocallyConvex.Basic
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Analysis_LocallyConvex_BalancedCoreHull(uint8_t builtin, lean_object* w) {
lean_object * res;
