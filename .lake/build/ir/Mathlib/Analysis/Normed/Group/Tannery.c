...
// Imports: Init Mathlib.Analysis.RCLike.Basic Mathlib.Analysis.Normed.Group.InfiniteSum
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Analysis_Normed_Group_Tannery(uint8_t builtin, lean_object* w) {
lean_object * res;
