...
// Imports: Init Mathlib.Analysis.Normed.Group.Uniform Mathlib.Topology.Instances.NNReal.Defs
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Analysis_Normed_Group_Lemmas(uint8_t builtin, lean_object* w) {
lean_object * res;
