...
// Imports: Init Mathlib.Analysis.InnerProductSpace.PiL2 Mathlib.Analysis.Normed.Lp.ProdLp
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Analysis_InnerProductSpace_ProdL2(uint8_t builtin, lean_object* w) {
lean_object * res;
