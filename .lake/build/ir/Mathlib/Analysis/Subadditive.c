...
// Imports: Init Mathlib.Order.Filter.AtTopBot.Archimedean Mathlib.Topology.Instances.Real.Defs
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Analysis_Subadditive(uint8_t builtin, lean_object* w) {
lean_object * res;
