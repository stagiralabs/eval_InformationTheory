...
// Imports: Init Mathlib.Analysis.Normed.Module.FiniteDimension Mathlib.Analysis.RCLike.Basic
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Analysis_RCLike_Lemmas(uint8_t builtin, lean_object* w) {
lean_object * res;
