...
// Imports: Init Mathlib.Analysis.Analytic.Constructions Mathlib.Analysis.Analytic.ChangeOrigin
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_Analysis_Analytic_Within(uint8_t builtin, lean_object* w) {
lean_object * res;
