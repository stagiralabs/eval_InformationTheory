...
// Imports: Init Mathlib.RingTheory.IntegralClosure.IsIntegral.Basic
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_FieldTheory_Minpoly_Basic(uint8_t builtin, lean_object* w) {
lean_object * res;
