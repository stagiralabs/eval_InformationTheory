...
// Imports: Init Mathlib.FieldTheory.IntermediateField.Adjoin.Basic
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_Mathlib_FieldTheory_Relrank(uint8_t builtin, lean_object* w) {
lean_object * res;
